      ...
      <div className="relative w-6 h-6">
        ...
        <svg
          className={`
            ...
            ${state.theme === 'dark' ? 'opacity-0 rotate-180 scale-0' : 'opacity-100 rotate-0 scale-100'}
        ...
        <svg
          className={`
            ...
            transition-all duration-500 ease-in-out
            ${state.theme === 'light' ? 'opacity-0 -rotate-180 scale-0' : 'opacity-100 rotate-0 scale-100'}
            ${isAnimating ? 'animate-spin' : ''}
          `}
          fill="currentColor"
          viewBox="0 0 20 20"
